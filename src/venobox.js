...
(function (root, factory) {
    ...
    let gallIndex, images, imgLoader, infinigall, items, navigationDisabled, newcontent, numeratio, nextok, prevok, overlay;
    let set_maxWidth, set_overlayColor, set_ratio, set_autoplay, set_href, startY, title, thisgall, thenext, theprev;
    ...
    const defaults = {
        ...
        share: false,
        shareStyle: 'pill', // 'block', 'pill', 'transparent', 'bar'
    ...
    */
    ...
    function setShareButtons(href){
        ...
        if (navigator.canShare) {
            ...
            blockshare.insertAdjacentHTML('beforeend', '<button type="button" class="vbox-link-btn vbox-share-mobile">'+shareIcon+'</button>');
        ...
        // Copy link
        blockshare.insertAdjacentHTML('beforeend', '<div class="vbox-tooltip"><button type="button" class="vbox-link-btn vbox-share-copy"><span class="vbox-tooltip-text" id="myTooltip"></span>'+linkIcon+'</button></div>');
